...
#### T1.1 - Normal 货物导航模型
**模型名称:** `single_R4.6.10_W2E4_T1.1_normal_20251009_140345`
**任务类型:** 从出发点到三个取货点，再从normal取货点到卸货点
**特点:** 作为基础模型

#### T6.1 - Enhanced Normal 导航模型
**模型名称:** `single_R4.6.10_W2E4_T6.1_normal_20251009_221340`
**任务类型:** 从出发点到三个取货点，再从三个取货点到卸货点
**特点:** 重新训练基础模型，将所有任务都纳入训练

#### T2.1 - Fragile 货物导航模型
**模型名称:** `single_R4.6.10_W2E4_T2.1_fragile_20251009_135707`
**任务类型:** 从fragile取货点到卸货点，从头训练
**特点:** 运动平滑，适合运输易碎物品，牺牲速度换取安全性

#### T3.4 - Dangerous 货物导航模型
**模型名称:** `single_R4.6.10_W2E4_T3.4_dangerous_20251013_162524`
**任务类型:** 从dangerous取货点到卸货点，从头训练
**特点:** 更高的安全性和任务完成率

#### T4.1 - Fragile 货物微调模型
**模型名称:** `single_R4.6.10_W2E4_T4.1_fragile_20251013_173803`
**任务类型:** 从fragile取货点到卸货点，在T6.1的基础上微调
**特点:** 在已有基础模型上进行微调，专门适配易碎货物运输，通过迁移学习获得更快的训练收敛速度和更稳定的性能

#### T5.2 - Dangerous 货物微调模型
**模型名称:** `single_R4.6.10_W2E4_T5.2_dangerous_20251013_224357`
**任务类型:** 从dangerous取货点到卸货点，在T6.1的基础上微调
**特点:** 在已有基础模型上进行微调，专门适配危险货物运输，通过迁移学习获得更快的训练收敛速度和更稳定的性能
